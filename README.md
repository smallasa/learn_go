...
```bash
liupengdeMBP:learn_go liupeng$ vim src/demo/08/q1/demo18.go 
package main
...
liupengdeMBP:learn_go liupeng$ go run src/demo/08/q1/demo18.go 
...
例如：
```bash
liupengdeMBP:learn_go liupeng$ vim src/demo/08/q1/demo19.go
package main
